...
This file is the entry point for GitHub Copilot agents and other AI assistants working in this repository. It provides orientation and points to the detailed guides that live alongside the code.
